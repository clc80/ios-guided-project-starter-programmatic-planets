...
class SettingsViewController: UIViewController {
    ...
    private func setUpSubviews() {
        ...
        let labelTopConstraint = label.centerYAnchor.constraint(equalTo: shouldShowPlutoSwitch.centerYAnchor)
        
        NSLayoutConstraint.activate([doneButtonTopConstraint, doneButtonTrailingConstraint, switchTopConstraint, switchTrailingConstraint, labelLeadingConstraint, labelTopConstraint])
